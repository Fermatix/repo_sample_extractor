...
Утилита для автоматического сбора репрезентативных кодовых сэмплов из git-репозиториев. Агент клонирует репозиторий, самостоятельно изучает его структуру и отбирает ~5 000 строк кода (жёсткий потолок — 6 500), отражающих типичное качество кодовой базы.
